...
function Guard(...fns) {
    return function (target, key, descriptor) {
        ...
        }, index_js_1.DComponent, index_js_1.DApplicationCommand, index_js_1.DSimpleCommand, index_js_1.DOn, index_js_1.DDiscord, index_js_1.DReaction).decorateUnknown(target, key, descriptor));
    };
}
exports.Guard = Guard;
