...
export declare class MetadataStorage {
    ...
    addApplicationCommandSlashGroups(group: DApplicationCommandGroup<DApplicationCommand>): void;
    addApplicationCommandSlashSubGroups(subGroup: DApplicationCommandGroup<DApplicationCommandOption>): void;
