...
export class MetadataStorage {
    ...
    async build() {
        ...
        await Modifier.applyFromModifierListToList(this._modifiers, this._modalComponents);
        await Modifier.applyFromModifierListToList(this._modifiers, this._reactions);
